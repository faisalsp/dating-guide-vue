    ...
    <div class="row g-5">
      <div class="col-12 col-lg-8">
        <form action="" method="post" class="">
          ...
          <div class="mb-3">
            ...
            <div class="bg-gray p-4">
              <InputField
                ...
                value="1"
                nowrapper
                title="Short Listing (only club listing displayed, club website is required)."
                checked
              />
              <InputField
                id="event-2"
          ...
          <h2 class="h4 fw-bold mb-3">Club Listing</h2>
          ...
          <InputField
            ...
            type="text"
            className="w-full"
            placeholder="(Example: Swingers Parties)"
            required
          />
          <InputField
            id="disLocation"
            ...
            type="text"
            className="w-full"
            helper="(Full address is optional, minimum required is City or Town)"
            required
          />
          <InputField
            id="gmapLocation"
          ...
          <InputField
            id="website"
            :title="clubPick === '1' ? 'Website*' : 'Website'"
            type="text"
            className="w-full"
          ...
          <div v-if="clubPick === '2'">
            ...
            <h2 class="h4 fw-bold mb-3">Full Details</h2>
