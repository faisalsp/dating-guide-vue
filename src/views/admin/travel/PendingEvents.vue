...
defineComponent({ name: 'PendingTravelEvents' })

</script>
<template>
  <div class="mx-auto">
    <div class="d-flex flex-wrap gap-1 align-items-center justify-content-between mb-4">
      <h1 class="h2 font-bold mb-0">Pending Travel Events</h1>
      <span class="fw-medium">Pending events remaining<span
            ...
            <div class="p-2">
              ...
              <div class="d-flex flex-column flex-xl-row gap-2">
                <div class="order-2 order-xl-1">
                  <small class="text-xs fw-bold">Tuesday, April 2, 2013 - Friday, April 12, 2013</small>
                  <p class="mb-0">Get set to party with lifestyle couples from all over the world! Known as "The
                    LifeStyle Event of the Decade," Vegas Exchange is the ultimate Lifestyle vacation for alternative lifestyle
                    adult couples.</p>
                  <p class="small text-success">Event Type: <span class="fw-medium text-black">Swingers
                      Parties</span></p>
                </div>
                <img src="https://placehold.co/500x500" class="order-1 order-xl-2 w-xl-25 object-fit-cover mt-2"
                  height="120" alt="">
              </div>
              ...
              <div class="d-flex flex-wrap column-gap-3">
                ...
                <InputField :id="'hothookups' + index" type="checkbox" title="HotHookups" nowrapper />
