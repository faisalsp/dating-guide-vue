...
const columns = [
  ...
  },
  {
    ...
    render: (data: string, type: any, row: { id: number }) => {
      return `<span class="badge bg-${data === 'Active' ? 'success' : 'danger'}">${data}</span><a href="events/edit/${row.id}" class="ms-3 text-dark text-decoration-none" data-item-id='${row.id}'><i class="gigacon gigacon-edit me-1"></i>Edit</a>`;
    }
  }
];
...
<template>
  <div class="mx-auto">
    ...
    <div class="d-flex gap-2 flex-wrap align-items-center">
      ...
      <RouterLink to="/user/create-event" class="btn btn-primary"
